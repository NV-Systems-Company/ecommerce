...
class RegisterPage extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            _buildRegisterForm(context, theme),
            SizedBox(
              height: 8.0,
            ),
            Container(
  ...
  _buildRegisterForm(BuildContext context, ThemeData theme) {
    return Column(
      children: <Widget>[
        Container(
          width: MediaQuery.of(context).size.width,
        ...
        Container(
          ...
          child: Flex(
            ...
            children: <Widget>[
              ...
              Icon(FontAwesomeIcons.eyeSlash, size: 20.0, color: Colors.grey.shade600,)
            ],
          ),
        ),
      ],
